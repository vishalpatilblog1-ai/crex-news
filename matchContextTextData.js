...
export const matchContext_T20_secondInning_live_india_match = {
  match: {
  ...
  event: {
    ...
    scoreCardStatus: "South Africa need 154 runs",
    isMatchComplete: false,
  },
  players: {
    striker: "Aiden Markram",
    nonStriker: "Dewald Brevis",
    strikerRuns: "",
    strikerBallsPlayed: "",
    nonStrikerRuns: "",
    nonStrikerBallsPlayed: "",
